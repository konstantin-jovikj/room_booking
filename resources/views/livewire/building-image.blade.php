<div class="flex justify-center items-center bg-gray-100 w-full">
    <div class="p-8 bg-white w-1/2 shadow-lg rounded-lg">
        ...
        <form wire:submit.prevent="upload" class=" mx-auto p-2 mt-2 rounded ">
            @csrf
            ...
            <div class="mb-4">
                <input type="hidden" wire:model="building_id" value="">

            </div>

            <div class="mb-4">
                <input type="file" class="w-full border @error('building_image') border-red-500 @enderror"
                    wire:model="building_image" placeholder="Building Image">
